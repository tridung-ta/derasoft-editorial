...
const KNOWLEDGE_CATEGORY_ID = 72; // Tin tức

$templateFile = 'knowledge.tpl.html';
$slugActive = 'kien-thuc';
...
if ($slug == 'case-study-cua-mpx') {
    $categoryObj = $articleCategories->getObject(KNOWLEDGE_CATEGORY_ID);
} else {
...
// Breadcrumb & topNav
$catName = $lang === 'en' ? ($categoryObj->getProperty('custom_en_name') ?: $categoryObj->name) : $categoryObj->name;
...
// Bài viết gần đây
$recentArticles = $articles->getObjects(1, "a.`status` = '1'", ['a.`id`' => 'DESC'], 4);
