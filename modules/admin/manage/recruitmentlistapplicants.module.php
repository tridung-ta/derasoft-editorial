...
$url = '/' . ADMIN_SCRIPT . "?op=manage&act=recruitment&mod=listapplicants&doo=$do&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pId=$pId&pg=%d";
$urls = new Url();
...
# Link
$link = '/' . ADMIN_SCRIPT . "?op=manage&act=recruitment&mod=listapplicants&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pId=$pId&pg=$page";
...
if ($_POST) {
	switch ($do) {
		...
		case 'cleantrash':
			...
			break;
		case 'cancel':
			header('location:' . '/' . ADMIN_SCRIPT . "?op=manage&act=recruitment&mod=listapplicants&lang=$lang&ecode=7&pId=$pId");
			exit;
			break;
	}
	header('location:' . '/' . ADMIN_SCRIPT . "?op=manage&act=recruitment&mod=listapplicants&doo=$do&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pg=$page&ecode=$error_code&rcode=$result_code&pId=$pId&pId2=$pId2");
}
