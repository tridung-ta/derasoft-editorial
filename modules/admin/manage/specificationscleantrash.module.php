...
Coder: Mai Minh
 **************************************************************************/
$userInfo->checkPermission('specifications', 'clean', 0);
...
$topNav = array(
	...
	$amessages['manage_product'] => '/' . ADMIN_SCRIPT . '?op=manage&act=specifications',
	$amessages['list_item'] => ''
);
...
# Link
$link = '/' . ADMIN_SCRIPT . "?op=manage&act=specifications&mod=list&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pId=$pId&pg=$page";
