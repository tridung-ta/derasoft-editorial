...
*/
	...
	var $driver;
	var $drivers=array(
		"Digest"   => array("digest_sasl_client_class",   "digest_sasl_client.class.php"   ),
		"CRAM-MD5" => array("cram_md5_sasl_client_class", "cram_md5_sasl_client.class.php" ),
		"LOGIN"    => array("login_sasl_client_class",    "login_sasl_client.class.php"    ),
		"NTLM"     => array("ntlm_sasl_client_class",     "ntlm_sasl_client.class.php"     ),
		"PLAIN"    => array("plain_sasl_client_class",    "plain_sasl_client.class.php"    ),
		"Basic"    => array("basic_sasl_client_class",    "basic_sasl_client.class.php"    )
	);
