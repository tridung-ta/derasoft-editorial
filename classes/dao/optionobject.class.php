...
include_once(ROOT_PATH . 'classes/dao/optionobjectinfo.class.php');

class OptionObject extends Model
{
	var $table;
	var $_db;
	var $store_id;
	...
	public function __construct($store_id = 0, $database = '')
	{
		...
		$this->table = DB_PREFIX . "custom_options_object";
		$this->store_id = $store_id;
	}
	public function OptionObject($store_id = 0, $database = '')
	{
