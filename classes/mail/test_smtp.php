 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	require("../sasl/sasl.class.php");

	$from="minh.mai@derasoft.com";                           /* Change this to your address like "me@mydomain.com"; */
	$sender_line=__LINE__;
	$to="maiminh2000@gmail.com";                             /* Change this to your test recipient address */
	...
	$smtp=new SmtpMail("mail.derasoft.com",25,"minh.mai@derasoft.com","succeed");
	...
	$smtp->user="minh.mai@derasoft.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="succeed";                 /* Set to the authetication password */
