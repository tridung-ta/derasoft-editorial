var MenuMatic = new Class({
	Implements: Options,
	options: {
        id: 'listmenu',//the id of the main menu (ul or ol)
...
var MenuMaticSubMenu = new Class({
    ...
    options: {
		...
		onHideAllSubMenus: (function(subMenuClass){}),
	...
	hideAllSubMenus: function(){
		...
		this.root.hideAllMenusTimeout = (function(){
			...
			this.options.onHideAllSubMenus(this);					
...
window.addEvent('domready', function(){	
	var myMenu = new MenuMatic({
		onShowSubMenu_complete: function(el){
			if(Browser.Engine.trident4){
				var _el = el.btn.retrieve('childMenu');
				var _elCoord = _el.getCoordinates();
				if(!el.ifm){
					el.ifm = new IFrame({
						'src': '',
						'frameborder': 0,
						...
						'styles': {
							top: _elCoord.top,
							left: _elCoord.left,
							width: _elCoord.width,
							height: _elCoord.height,
							position: 'absolute'							
						}
		...
		onHideSubMenu_complete: function(el){
			if(Browser.Engine.trident4){
				if(el.ifm){
					el.ifm.destroy();
					delete el.ifm;
